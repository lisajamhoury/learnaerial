...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.venue_url'
        db.add_column(u'events_event', 'venue_url',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.venue_url'
        db.delete_column(u'events_event', 'venue_url')
    ...
    models = {
        u'events.event': {
            ...
            'venue_url': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        }
    }
